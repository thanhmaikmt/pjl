...
def fixJ(K,C,b,dxdt,It,state):
    ...
    for i in range(n_node):
        ...
        if sPrev != sEsurf or aE <= 1e-18:
            print "depth",i
            return
         
    print "Oooops saturation ............"


def evaluate(dxdt,x,dxdt_guess,It,dt,state):
    
        assemble(K,C)
        flag=fixJ(K,C,b,dxdt_guess,It,state)
        #if flag:
