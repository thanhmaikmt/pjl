...
public class SimphoneyApp implements SimphoneyAppInterface {

    boolean packFrame = false;

    String user; // = Defaults.user;

   static  SimphoneyApp the;

    static public SimphoneyApp the() { return the; }
    ...
    public SimphoneyApp(String user) {
