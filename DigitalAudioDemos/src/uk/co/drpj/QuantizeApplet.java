...
//@AppletServerClass
public class QuantizeApplet extends JApplet {

    private static final long serialVersionUID = 1L;

  // AudioSystem audioSystem;
    private QuantizePanel panel;
    ...
    public void start() {
        ...
        try {
            panel = new QuantizePanel();
        } catch (Exception ex) {
            Logger.getLogger(QuantizeApplet.class.getName()).log(Level.SEVERE, null, ex);
        }
