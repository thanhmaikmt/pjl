...
//        running=true;
    ...
    void load(BufferedReader reader) throws RedCodeParseException {
        ...
        while (true) {
            try {
                ...
                Logger.getLogger(Machine.class.getName()).log(Level.SEVERE, null, ex);
                throw new RedCodeParseException(str1,parseLine);
            }
        }
        notifyObservers();
        return;
    ...
    public class Instruction {
        ...
        Instruction(String line1) throws RedCodeParseException {
            ...
            if (code == null) {
                throw new RedCodeParseException("Invalid instruction \"" + toks[0] +"\"",parseLine);
            }

            switch (code) {
                case DAT:
                    if (toks.length < 2) {
                        throw new RedCodeParseException(" Expected an operand !", parseLine);
                    }
                    //opA = new OperandA("0");
                ...
                default:
                    if (toks.length < 3) {
                        throw new RedCodeParseException(" Expected 2 operands !", parseLine);
                    }
                    opA = new OperandA(toks[1]);
            ...
            Operand(String str1, BitSection bits, UBitSection modeBit) throws RedCodeParseException {
                ...
                if (str.charAt(0) == '\'') {
                    ...
                    try {
                        ...
                        throw new RedCodeParseException(" Malformed operand \"" + str +"\"", parseLine);
                    }
                }
