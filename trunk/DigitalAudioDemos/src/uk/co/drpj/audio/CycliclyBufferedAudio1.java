 ...
 * @author pjl
 */
public class CycliclyBufferedAudio1 {
    ...
    public CycliclyBufferedAudio1(int cacheSize, float Fs) {
    ...
    public void grabEnd(float x[], int nSamp) {
     //   synchronized (muex) {
