...
"this code managed to get half way through the maze but it uses a [7,7,4] netwrok instead of [15,7,4]"
...
print "Do you want to load pool (hint yes you do) press ,y,"
var = raw_input("Enter y or n ")
...
POOL_FILE_NAME="maze_hover_ems_pool1.txt"
