...
import uk.org.toot.audio.filter.FIRFilter;
import uk.org.toot.audio.filter.Filter;
import uk.org.toot.audio.filter.Filter.Type;
 ...
 * @author pjl
 */
public class ADC2Panel extends JPanel {
    ...
    private DitherProcess preFilter;
    private boolean cancel;
    private boolean quantizeOn;
    private boolean preFilterOn;
    AudioSystem audioSystem;
    private JLabel qlab;

    public ADC2Panel() throws Exception {
...
//        if (url) {
       URL u = ((new File("/home/pjl/audiodump.wav")).toURI()).toURL();
     //  audioReader = new URLWavReader(u);
       //   URL u = ((new File("/home/pjl/dangermouse.mp3")).toURI()).toURL();
       audioReader= new MP3AudioReader("file:/home/pjl/MissionImpossible.mp3",2.0f);

        quantizer = new QuantizerProcess();

        float Fs=11000;
        
        final float preCutoff=Fs/2;
    ...
    public void start() {
        try {
            ...
            Logger.getLogger(ADC2Panel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void configure() {
        ...
        combo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (quantizer != null) {
                    ...
                    preFilter.setQuantizelevel(quantizer.getQuant());
        ...
        dither.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                preFilterOn = dither.isSelected();
                double val = amt.getDoubleValue();
                preFilter.setDither((float) val);
                if (preFilterOn) {
